...
else
{
	...
	for(i=1;i<10;i++)
	{
		if(argument1 >= i && keyboard_check_pressed(get_vk_numpad_script(i)))
		{
			...
			//set current action
			object.current_action = string_lower(get_current_perso_script().actions_list[i-1]) + "_script";
		}
	}
